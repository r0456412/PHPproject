<?php
/**
 * @file planning_admin.php
 * 
 * View waarin de admin de planning kan opvragen voor de verschillende dagen van de internationale dagen
...
<script>
    ...
    function haalPlanningOp ( jos ) {
        $.ajax({type : "GET",
                url : site_url + "/planning/haalAjaxOp_datum",
                data : { datumid : jos },
